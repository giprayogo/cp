...
// Math problem 🙃. Embarassing but... at least I went to solution quick.
// Yeah need more problems so that I don't make stupid math problem!
...
fn test_solution() {
    ...
    assert_eq!(
        Solution::car_fleet(16, vec![11, 14, 13, 6], vec![2, 2, 6, 7]),
        2
    );
    assert_eq!(
        Solution::car_fleet(
            21,
            vec![1, 15, 6, 8, 18, 14, 16, 2, 19, 17, 3, 20, 5],
            vec![8, 5, 5, 7, 10, 10, 7, 9, 3, 4, 4, 10, 2]
        ),
        7
    )
}
