...
impl Solution {
    ...
    // correction: actually dijkstra; but without memoizing the shortest path/
    // distance to every node. also instead of moving priority in the heap;
    // simply reject one that comes later
